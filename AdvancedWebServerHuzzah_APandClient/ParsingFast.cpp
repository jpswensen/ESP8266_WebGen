...
bool ESP8266WebServerFast::_parseRequest(WiFiClient& client) {
...
void ESP8266WebServerFast::_parseArguments(String data) {
#ifdef DEBUG
...
void ESP8266WebServerFast::_uploadWriteByte(uint8_t b){
...
uint8_t ESP8266WebServerFast::_uploadReadByte(WiFiClient& client){
  int res = client.read();
  if(res == -1){
...
bool ESP8266WebServerFast::_parseForm(WiFiClient& client, String boundary, uint32_t len){
...
bool ESP8266WebServerFast::_parseFormUploadAborted(){
