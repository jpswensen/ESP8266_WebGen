...
public:
    FunctionRequestHandler(ESP8266WebServerFast::THandlerFunction fn, const char* uri, HTTPMethod method)
    : _fn(fn)
    , _uri(uri)
    , _method(method)
    {
    ...
    bool handle(ESP8266WebServerFast& server, HTTPMethod requestMethod, String requestUri) override {
...
protected:
    String _uri;
    HTTPMethod _method;
    ESP8266WebServerFast::THandlerFunction _fn;
};
